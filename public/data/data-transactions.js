export const transactions = [
  {
    avatar: `${imageUrl}emma-richardson.jpg`,
  ...
  {
    avatar: `${imageUrl}savory-bites-bistro.jpg`,
  ...
  {
    avatar: `${imageUrl}daniel-carter.jpg`,
    name: "Daniel Carter",
    category: "General",
  ...
  {
    avatar: `${imageUrl}urban-services-hub.jpg`,
  ...
  {
    avatar: `${imageUrl}liam-hughes.jpg`,
    name: "Liam Hughes",
    category: "Groceries",
  ...
  {
    avatar: `${imageUrl}lily-ramirez.jpg`,
    name: "Lily Ramirez",
    category: "General",
  ...
  {
    avatar: `${imageUrl}ethan-clark.jpg`,
    name: "Ethan Clark",
    category: "Dining Out",
  ...
  {
    avatar: `${imageUrl}james-thompson.jpg`,
    name: "James Thompson",
  ...
  {
    avatar: `${imageUrl}pixel-playground.jpg`,
  ...
  {
    avatar: `${imageUrl}ella-phillips.jpg`,
    name: "Ella Phillips",
    category: "Dining Out",
  ...
  {
    avatar: `${imageUrl}sofia-peterson.jpg`,
    name: "Sofia Peterson",
  ...
  {
    avatar: `${imageUrl}mason-martinez.jpg`,
    name: "Mason Martinez",
    category: "Lifestyle",
  ...
  {
    avatar: `${imageUrl}green-plate-eatery.jpg`,
  ...
  {
    avatar: `${imageUrl}sebastian-cook.jpg`,
    name: "Sebastian Cook",
    category: "Transportation",
  ...
  {
    avatar: `${imageUrl}william-harris.jpg`,
    name: "William Harris",
  ...
  {
    avatar: `${imageUrl}elevate-education.jpg`,
  ...
  {
    avatar: `${imageUrl}serenity-spa-and-wellness.jpg`,
  ...
  {
    avatar: `${imageUrl}spark-electric-solutions.jpg`,
  ...
  {
    avatar: `${imageUrl}swift-ride-share.jpg`,
  ...
  {
    avatar: `${imageUrl}aqua-flow-utilities.jpg`,
  ...
  {
    avatar: `${imageUrl}ecofuel-energy.jpg`,
    name: "EcoFuel Energy",
    category: "Bills",
  ...
  {
    avatar: `${imageUrl}flavor-fiesta.jpg`,
    name: "Flavor Fiesta",
    category: "Dining Out",
  ...
  {
    avatar: `${imageUrl}harper-edwards.jpg`,
    name: "Harper Edwards",
    category: "Shopping",
  ...
  {
    avatar: `${imageUrl}buzz-marketing-group.jpg`,
  ...
  {
    avatar: `${imageUrl}technova-innovations.jpg`,
  ...
  {
    avatar: `${imageUrl}nimbus-data-storage.jpg`,
